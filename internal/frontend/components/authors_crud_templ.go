...
func AuthorsPage(tokenKey string, authors []jsonreqresp.AuthorResponse) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"crud-container\" id=\"authorsContainer\"><!-- Модальное окно для добавления/редактирования --><div class=\"modal\" id=\"authorModal\" style=\"display: none;\"><div class=\"modal-content\" onclick=\"event.stopPropagation()\"><h3 id=\"modalTitle\">Добавить автора</h3><form id=\"authorForm\" onsubmit=\"return handleFormSubmit(event)\"><input type=\"hidden\" id=\"authorId\"><div class=\"form-group\"><label>Имя автора</label> <input type=\"text\" id=\"authorName\" required minlength=\"2\" maxlength=\"100\"></div><div class=\"form-group\"><label>Год рождения</label> <input type=\"number\" id=\"birthYear\" required min=\"1000\"></div><div class=\"form-group\"><label>Год смерти (необязательно)</label> <input type=\"number\" id=\"deathYear\" min=\"1000\"></div><div class=\"form-actions\"><button type=\"button\" onclick=\"closeModal()\">Отмена</button> <button type=\"submit\" id=\"submitButton\">Добавить</button></div></form></div></div><!-- Основной интерфейс --><div class=\"crud-header\"><h2>Авторы</h2><button class=\"add-button\" onclick=\"resetAndOpenModal()\">+ Добавить автора</button></div><!-- Таблица авторов --><table class=\"crud-table\"><thead><tr><th>Имя</th><th>Годы жизни</th><th>Действия</th></tr></thead> <tbody>")
			if templ_7745c5c3_Err != nil {
			...
			for _, author := range authors {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "\">✏️</button> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
